...
import torch
from chimera.model.chimera import ChimeraChatConfig, ChimeraChatModel
from transformers import AutoTokenizer
# from chimera.model.chimera.modeling_internvl_chat import InternVLChatModel
...
def load_model_and_tokenizer(args):
    if args.auto:
        config = ChimeraChatConfig.from_pretrained(args.checkpoint)
